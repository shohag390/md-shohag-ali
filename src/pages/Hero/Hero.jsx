  ...
  return (
    <div className="2xl:h-[88vh] lg:h-[90vh] h-full lg:py-0 py-[50px] 2xl:px-[180px] lg:px-[100px] px-[20px] hero flex lg:flex-row flex-col items-center justify-between lg:gap-0 gap-[30px]">
      <div className="lg:w-[50%] w-full" data-aos="fade-up">
        ...
        <h4
          className={`2xl:text-[40px] lg:text-[35px] text-[22px] lg:font-bold font-semibold ${
        ...
        <h4
          className={`2xl:text-[40px] lg:text-[35px] text-[22px] lg:font-bold font-semibold flex items-center gap-2 ${
            theme === "light" ? "text-[#f0f4f8]" : "text-[#ffffffd5]"
          }`}
        >
          I'm A
