...
const Hero = () => {
  ...
  return (
    <div className="lg:h-[88vh] md:h-[90px] h-[92vh] lg:px-[140px] md:px-[50px] px-[20px] hero flex items-center justify-between">
      <div className="w-[50%]">
        ...
        <h4 className="text-[35px] font-bold text-[#ffffffd5]">
          I'm Md Shohag Ali
        </h4>
        ...
        <div className="flex items-center gap-[10px]">
          <button
            ...
            className="py-[12px] px-[30px] bg-gradient-to-r from-[#6BFDD9] to-[#F0FF6C] rounded-full flex items-center justify-center font-medium duration-500 hover:from-[#F0FF6C] hover:to-[#6BFDD9]"
          >
            Download Resume
          </button>
        </div>
