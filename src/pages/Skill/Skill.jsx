...
import { SiTailwindcss, SiJavascript, SiNextdotjs, SiExpress, SiMongodb, SiFirebase, SiTypescript, SiBootstrap, SiFigma, SiRedux, SiVercel, SiNetlify } from "react-icons/si";
...
const webDeveloperSkills = [
    ...
    { id: 3, name: "Tailwind CSS", icon: <SiTailwindcss className="text-[#38BDF8]" /> },
    { id: 4, name: "JavaScript (ES6+)", icon: <SiJavascript className="text-[#F7DF1E]" /> },
    ...
    { id: 13, name: "Bootstrap", icon: <SiBootstrap className="text-[#7952B3]" /> },
...
const Skill = () => {
    return (
        <div className='container mx-auto lg:px-[100px] md:px-[50px] px-[20px] py-[60px]'>
            <div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-[20px]">
                {webDeveloperSkills.map(skill => (
                    <div key={skill.id} className="bg-[#FFFFFF0F] p-[20px] rounded-xl border-[1px] border-[#ffffff1d] flex items-center justify-between">
                        <div className="h-[70px] w-[70px] bg-[#6bfdd822] text-[#F0FF6C] flex items-center justify-center text-[30px] rounded-xl">
                            {skill.icon}
                        </div>
                        <h4 className="text-[#ffffffd5] text-[18px]">
                            {skill.name}
                        </h4>
                    </div>
                ))}
