...
const About = () => {
    return (
        <section className='scroll-mt-[11vh] w-full container mx-auto lg:px-[120px] md:px-[50px] px-[20px] lg:py-[80px] bg-[#050709] flex items-center gap-[20px]' id='about'>
            ...
            <div className="w-[60%]">
                <h2 className="font-medium text-[40px] bg-gradient-to-r from-[#8750f7] to-[#ffffff] text-transparent bg-clip-text capitalize leading-[55px]">About Me</h2>
                <p className="leading-relaxed text-gray-300 text-justify pt-[20px] pb-[15px]">
